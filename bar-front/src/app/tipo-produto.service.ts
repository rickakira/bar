...
export class TipoProdutoService {
  ...
  private baseUrl = 'http://localhost:8090/api/produto/tipo';  
  
  constructor(private http:HttpClient) { }  
  
  getTipoProdutoList(): Observable<any> {  
  ...
  getTipoProdutoById(id: number): Observable<Object> {  
    return this.http.get(`${this.baseUrl}/${id}`);  
  }  

  getTipoProdutoByDescricao(descricao: String): Observable<Object> {  
